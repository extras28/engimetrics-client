...
function KeenSelectOption({
    ...
    const [dropdownValue, setDropdownValue] = useState(!emptyLabel ? 'Chưa chọn' : emptyLabel);
    ...
    useEffect(() => {
        if (value === '') {
            setDropdownValue(!emptyLabel ? 'Chưa chọn' : emptyLabel);
        } else {
            setDropdownValue(
            ...
            <div className={`${selectClassName}`}>
                <Dropdown>
                    <Dropdown.Toggle
                        ...
                        } ${disabled ? 'bg-light' : 'bg-white'} w-100`}
